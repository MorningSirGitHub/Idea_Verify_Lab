...
public class HyperlinkControl : MonoBehaviour
{
    ...
    private string UnicodeCodePointToString(string emojiString)
    {
        ...
        return unicodeName.Remove(unicodeName.Length - 1, 1).ToString();
    }
    private void OnEnable()
    {
        //var test = "©";
        //Debug.LogError(UnicodeCodePointToString(test));

        //string emojiStringInput = "rty😍rueu😀s收拾🙋收拾f😜er水电费2342🤣sdfs🤺df- ☔  🏴- 🙋‍♂️👁️‍🗨️";
        //Debug.LogError(Regex.Replace(emojiStringInput, @"\P{S}", ""));
        ...
        //var matchlist = Regex.Matches(emojiStringInput, EmojiPattern);
        //Debug.LogError(matchlist.Count);
        ...
        //    Debug.LogError(UnicodeCodePointToString(match.Value));
        //}
    }
